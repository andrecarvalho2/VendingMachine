...
#define SCVI_STATECHART_MAIN_REGION__IDLE_ 0
#define SCVI_STATECHART_MAIN_REGION__BROWSING_ 0
#define SCVI_STATECHART_MAIN_REGION__DISPENSE_ 0
#define SCVI_STATECHART_MAIN_REGION__CREDIT_GET_ 0
...
typedef enum  {
	...
	Statechart_but_coin1,
	Statechart_but_coin2,
...
typedef enum
{
	...
	Statechart_main_region__Idle_,
	Statechart_main_region__browsing_,
	Statechart_main_region__Dispense_,
	Statechart_main_region__Credit_get_
} StatechartStates;
...
extern void statechart_but_raise_coin1(Statechart* handle);
/*! Raises the in event 'coin2' that is defined in the interface scope 'but'. */ 
extern void statechart_but_raise_coin2(Statechart* handle);
